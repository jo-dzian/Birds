...
task2_tern <- c('Incubating', '2004-05-21', '2004-06-30') #40
...
tern_layout <- ((tern_line_plot_1  + tern_box_plot_2))+
  tern_vp_plot +
...
ggsave(tern_layout, 
       file = paste0("D:/Ptaki_hydro/Obliczenia/R/Kalibracja_Q_PL/Q_mod_obs/tern/tern_layout.jpg", 
                     ".jpg"), #saving the plot into a folder
       device = "jpg",
       width = 7,
       height = 20)
...
tern_interv_i1 <- as.interval(ddays(41), start = ISOdate(2004:2018, 5, 21, 0, tz = 'Europe/Warsaw'))
